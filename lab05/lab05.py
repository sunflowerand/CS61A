...
def distance(city_a, city_b):
    ...
    return sqrt((city_a_lat - city_b_lat)**2 + (city_b_lon - city_a_lon)**2)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    city_a_dis = distance(temp, city_a)
    city_b_dis = distance(temp, city_b)
    if(city_a_dis < city_b_dis):
